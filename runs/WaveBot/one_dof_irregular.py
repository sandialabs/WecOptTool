...
spread_name = f'cosine-2S, s_max = {s_max}'
...
def spread(freq, dir):
    return wot.waves.spread_cos2s(freq, dir, 1.0/period_peak, s_max)


waves = wot.waves.irregular_wave(
    f0, num_freq, wave_direction, spectrum, spread, spectrum_name, spread_name)
