...
plt.figure()
t_dom['pto_force'].sel(dof_pto='HEAVE PTO').plot()

plt.figure()
t_dom['pto_force'].sel(dof_pto='PITCH PTO').plot()
...
plt.figure()
np.abs(f_dom['pto_force'].sel(dof_pto='HEAVE PTO')).plot(**fd_lines)

plt.figure()
np.abs(f_dom['pto_force'].sel(dof_pto='PITCH PTO')).plot(**fd_lines)
